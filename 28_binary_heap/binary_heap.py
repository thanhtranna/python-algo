...
class BinaryHeap:
    ...
    def _heapify(self, data, tail_idx):
        """
        Internal implementation of heap
        :param data: data to be heaped
        :param tail_idx: index of tail element
        :return:
        """
    ...
    def _heap_down(data, idx, tail_idx):
        """
        Stack the specified location
        :param data: data to be heaped
        :param idx: data: the location that needs to be heaped
        :param tail_idx: index of tail element
        :return:
        """
    ...
    def _remove_top(data):
        """
        Take the top of the heap internal realization
        :param data:
        :return:
        """
        assert type(data) is list
    ...
    def _draw_heap(data):
        ...
        for i, n in enumerate(data):
            ret += str(n)
            # The last line break of each line
